...
$doctrineVersion = getenv('DOCTRINE');
if ($doctrineVersion == 'orig') {
	$doctrineVersion = false;
}
if (!$netteVersion && !$doctrineVersion) {
...
if ($doctrineVersion) {
	...
	replaceVersion($composer['require'], $consolePackages, $doctrineVersion);
}
